...
def make_figure_7c(ax):
		...
		#open CSV file
		with open('../fig7c.csv') as csvDataFile:
		...
		ax.set_title('(c) 4F-PSPCz',pad=10)
		...
		#plt.savefig('/Users/gvnjones/Projects/gavinjones/mccoled/docs/npjcompmat/fig7c.pdf', dpi=900)
