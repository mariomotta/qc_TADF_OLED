...
#open CSV file
with open('/Users/gvnjones/Projects/gavinjones/mccoled/docs/npjcompmat/fig4c.csv') as csvDataFile:
...
ax.scatter(method,sfdzFloat, color="blue", marker=".", linewidth=6)     #plot the data with point as the marker for each points

ax.set_title('(c) 4F-PSPCz')
...
plt.savefig('/Users/gvnjones/Projects/gavinjones/mccoled/docs/npjcompmat/fig4c.pdf', dpi=900)
